...
import { FiCode, FiDatabase, FiCpu, FiServer, FiLayers, FiCloud } from 'react-icons/fi';
...
export default function HomepageExamples() {
  ...
  return (
    <section id='projects' ref={ref} className='relative isolate z-50 bg-[#0b0f19] py-24'>
      {/* Subtle glow */}
        ...
        <div className='grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3'>
          {examples
            ...
            .map((project, index) => (
              ...
              >
                {/* Index */}
                <div className='to-primary-dark absolute -left-4 -top-4 flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-primary font-bold text-white shadow-lg'>
                  #{index + 1}
                </div>
                ...
                {/* Description */}
                <p className='mb-6 flex-1 text-sm leading-relaxed text-gray-300'>{project.text}</p>
